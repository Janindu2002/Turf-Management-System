...
ALTER TABLE bookings ADD COLUMN coach_approval_status VARCHAR(20) DEFAULT 'none';
ALTER TABLE bookings ADD COLUMN admin_approval_status VARCHAR(20) DEFAULT 'pending';

-- Add updated_at to coaches table
ALTER TABLE coaches ADD COLUMN updated_at TIMESTAMP DEFAULT now();
